...
There are multiple ways to find a hyper-plane which minimizes the original 0/1 loss function (sum of 0/1 losses), which have been described in details in [@doerr2015direct]. 

The Python, Java, and Matlab code for [@bonyadi2019optimal] is available [@bonyadi2019optimalcode]. 

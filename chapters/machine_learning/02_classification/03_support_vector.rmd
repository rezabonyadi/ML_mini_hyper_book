...
* Consider a binary classification problem and assume we want to use a hyperplane (linear model) to separate the classes. 
...
* SVM can be also used for supervised dimensionality reduction, see [@tao2008recursive].

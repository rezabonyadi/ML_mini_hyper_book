...
Given this data, we have been asked to which class a person belong if their Height is 6 (>5.5, hence 'Y'), their Weight is 130 (<150, hence 'N'), and their Foot size is 8 (<10, hence 'N'). Prior probability of being male is 0.5 and being female is 0.5, based on the table. It is clear that $P(x_1=Y|Y=female)=0.25$, $P(x_2=N|Y=female)=1$ is cac
Y N N
0.25*1*1*.5=0.125
1*.25*0.25*.5=0.03125
